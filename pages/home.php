...
<div class="container-fluid titre">
    <?php if(isset($_POST['afficherTousLesProduits'])){ ?>  
        <h1>ALL OUR PRODUCTS</h1> 
    <?php }elseif(isset($_POST['trierPar'])){ ?>
        <h1>ALL OUR PRODUCTS</h1> 
    <?php }else{ ?>  
        <h1>NEW PRODUCTS</h1> 
    <?php }?>   
...
<div class="container-xxl product">
    <div class="row productRow">
        <?php foreach ($result as $data) { ?>
            <div class="col-md-3">
                <form method="POST" name="ajtpanier">
                    <div class="ficheProduct">
                        ...
                        <h3><?= $data-> Name ?></h3>
                        <img name src="<?= $data-> Image ?>" alt="">
                        <p><?= $data-> Description ?></p>
                        <h6>Prix : <?= $data-> Price ?>€ </h6>
                        <!-- <h6>CHAMP : <?= $data-> CHAMP ?></h6> -->
...
<div class="container-fluid titre">
    <?php include "functions/afficherProduit.php" ?>
    <form method="POST">
        <button name="afficherTousLesProduits" type="submit">Show all products</button>
    </form>
</div>
